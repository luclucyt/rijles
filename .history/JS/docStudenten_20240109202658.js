...
studenten.forEach((student) => {
    student.addEventListener("click", (e) => {
        ...
        xhr.onload = function () {
            ...
            document.querySelector(".studenten-naam").innerHTML = response.naam;
            document.querySelector(".studenten-mail").innerHTML = response.mail;
            document.querySelector(".studenten-adres").innerHTML =
                response.adres;
            document.querySelector(".studenten-postcode").innerHTML =
                response.postcode;
            document.querySelector(".studenten-lessen").innerHTML =
                response.lessenGebruikt;
            document.querySelector(".studenten-aanstaandeles").innerHTML =
